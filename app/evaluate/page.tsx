...
export default function EvaluationForm() {
  ...
  const steps = [
    ...
    { id: 2, name: "Product Goal & Plan", completed: false },
    { id: 3, name: "Innovation & Feasibility", completed: false },
        ...
        <form className="max-w-3xl mx-auto space-y-6">
          <div className="space-y-4">
            <div>
              ...
              <Input placeholder="Placeholder text" className="mt-2" required />
            </div>
            <div>
              <Label>
            ...
            <div>
              ...
              <Textarea placeholder="Placeholder text" className="mt-2" required />
            </div>
            <div>
              <Label>
              ...
              <RadioGroup className="mt-2 space-y-2">
                <div className="flex items-center space-x-2">
                  ...
                  <Label htmlFor="ideation" className="text-sm">
                    Ideation Stage - Pre-seed Stage, problem-solution fit
                  </Label>
                </div>
                <div className="flex items-center space-x-2">
                  <RadioGroupItem value="early" id="early" />
                  <Label htmlFor="early" className="text-sm">
                    Early stage - Seed Stage, Developing a MVP
                  </Label>
                </div>
                <div className="flex items-center space-x-2">
                  <RadioGroupItem value="growth" id="growth" />
                  <Label htmlFor="growth" className="text-sm">
                    Growth Stage - Series A & B, product-market fit
                  </Label>
                </div>
                <div className="flex items-center space-x-2">
